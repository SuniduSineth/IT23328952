...
│  └─ tests/
│     ├─ IT23328952_negative_functional.spec.ts
│     ├─ IT23328952_negative_ui.spec.ts
|     ├─ IT23328952_positive_functional.spec.ts
│     └─ IT23328952_positive_ui.spec.ts
├─ IT23328952_GitHub_Link.txt
├─ IT23328952_TestCases.xlsx
├─ package-lock.json
├─ package.json
└─ README.md
```
